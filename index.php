        ...
        <div class="main-content d-flex flex-column px-0">
            ...
            <div class="m-auto mw-510 py-5">
                <form method="post">
                    ...
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <div class="form-group mb-4">
                                ...
                                <input type="test" name="username" class="form-control h-58" placeholder="envytheme@info.com">
                            </div>
                            <div class="form-group mb-0">
                                <label class="label">Password</label>
                                <div class="form-group">
                                    <div class="password-wrapper position-relative">
                                        <input type="password" name="password" id="password" class="form-control h-58 text-dark"
                                            value="@password#">
                    ...
                    <button name="login" class="btn btn-primary fs-16 fw-semibold text-dark heading-fornt py-2 py-md-3 px-4 text-white w-100" type="submit">Login</button>
                </form>
            </div>
